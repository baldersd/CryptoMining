#!/bin/bash
#just doing fans for X11 as my stock clocks are optimal.
nvidia-smi -pm 1
...
nvidia-settings -c :0 -a '[gpu:0]/GPUGraphicsClockOffset[2]=0'
nvidia-settings -c :0 -a '[gpu:2]/GPUGraphicsClockOffset[2]=0'
...
nvidia-settings -c :0 -a '[gpu:1]/GPUGraphicsClockOffset[2]=0'
nvidia-settings -c :0 -a '[gpu:3]/GPUGraphicsClockOffset[2]=0'
nvidia-settings -a [gpu:1]/GPUFanControlState=1 -a [fan:1]/GPUTargetFanSpeed=80 -c :0.0
nvidia-settings -a [gpu:3]/GPUFanControlState=1 -a [fan:3]/GPUTargetFanSpeed=85 -c :0.0
#<gtx 1080
nvidia-settings -c :0 -a '[gpu:4]/GPUMemoryTransferRateOffset[2]=0'
nvidia-settings -c :0 -a '[gpu:4]/GPUGraphicsClockOffset[2]=0'
