...
#<gtx 1050tis
nvidia-settings -c :0 -a '[gpu:0]/GPUMemoryTransferRateOffset[2]=500'
nvidia-settings -c :0 -a '[gpu:2]/GPUMemoryTransferRateOffset[2]=700'
nvidia-settings -c :0 -a '[gpu:0]/GPUGraphicsClockOffset[2]=190'
nvidia-settings -c :0 -a '[gpu:2]/GPUGraphicsClockOffset[2]=180'
...
nvidia-settings -c :0 -a '[gpu:3]/GPUMemoryTransferRateOffset[2]=500'
nvidia-settings -c :0 -a '[gpu:1]/GPUGraphicsClockOffset[2]=180'
...
#<gtx 1080
nvidia-settings -c :0 -a '[gpu:4]/GPUMemoryTransferRateOffset[2]=1100'
nvidia-settings -c :0 -a '[gpu:4]/GPUGraphicsClockOffset[2]=180'
